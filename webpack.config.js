...
Encore
  ...
  .enableSassLoader((options) => {
    // Use dart-sass (the 'sass' package) as the implementation
  ...
  // Configure CSS loader to ignore absolute URLs (for images in public/)
  .configureCssLoader((options) => {
    options.url = {
      filter: (url) => {
        // Don't process absolute URLs starting with /
